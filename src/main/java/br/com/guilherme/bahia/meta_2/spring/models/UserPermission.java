...
public class UserPermission implements Serializable {
    ...
    public Permission getPermId() {
        return permId;
    }

    public void setPermId(Permission permId) {
        this.permId = permId;
    }
    ...
    public String toString() {
        return "br.com.guilherme.bahia.meta_2.spring.models.UserPermission[ id=" + id + " ]";
    }
